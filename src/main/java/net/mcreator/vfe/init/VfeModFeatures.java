...
import net.mcreator.vfe.world.features.plants.SalatFeature;
...
public class VfeModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(SalatFeature.FEATURE,
				new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, SalatFeature.GENERATE_BIOMES, SalatFeature.CONFIGURED_FEATURE));
	}
